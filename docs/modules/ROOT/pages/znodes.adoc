...
In the Stackable Operator for Apache ZooKeeper, we manage ZNodes using the _ZookeeperZnode_ resource. 
...
Have a look at the usage guide for ZNodes: xref:usage_guide:using_znodes.adoc[]