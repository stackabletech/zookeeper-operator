...
For a full list of configuration options we refer to the Apache ZooKeeper https://zookeeper.apache.org/doc/r3.8.2/zookeeperAdmin.html#sc_configuration[Configuration Reference].
