...
Apache ZooKeeper organizes all data into a hierarchical system of https://zookeeper.apache.org/doc/r3.8.2/zookeeperProgrammers.html#ch_zkDataModel[ZNodes],
