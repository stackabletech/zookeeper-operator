...
Apache ZooKeeper organizes all data into a hierarchical system of https://zookeeper.apache.org/doc/r3.9.6/zookeeperProgrammers.html#sc_zkDataModel_znodes,
