...
:crd: {crd-ref}{crd-ref-release}&operator=zookeeper-operator
:crd-zookeepercluster: {crd-ref}/zookeeper.stackable.tech/v1alpha1/zookeepercluster{crd-ref-release}
:crd-zookeeperznode: {crd-ref}/zookeeper.stackable.tech/v1alpha1/zookeeperznode{crd-ref-release}
