...
The Stackable Operator for Apache ZooKeeper will stop the support of following versions of ZooKeeper in the next releases:

include::partial$deprecated-versions.adoc[]

== Removed Versions

The Stackable Operator for Apache ZooKeeper does not support the previously supported versions of ZooKeeper anymore:

include::partial$removed-versions.adoc[]
