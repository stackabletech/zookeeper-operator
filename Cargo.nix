  ...
  internal = rec {
    ...
    crates = {
      ...
      "k8s-version" = rec {
        ...
        version = "0.1.3";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../operator-rs/main/crates/k8s-version; };
        libName = "k8s_version";
        authors = [
      ...
      "opentelemetry-semantic-conventions" = rec {
        ...
        version = "0.29.0";
        edition = "2021";
        sha256 = "1qvaf3wvf3b40rifklvi767krv7yn8cjzaasdn9m9agii6grmcl4";
      ...
      "stackable-certs" = rec {
        ...
        version = "0.3.1";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../operator-rs/main/crates/stackable-certs; };
      ...
      "stackable-operator" = rec {
        ...
        version = "0.93.2";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../operator-rs/main/crates/stackable-operator; };
      ...
      "stackable-operator-derive" = rec {
        ...
        version = "0.3.1";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../operator-rs/main/crates/stackable-operator-derive; };
        procMacro = true;
      ...
      "stackable-shared" = rec {
        ...
        version = "0.0.1";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../operator-rs/main/crates/stackable-shared; };
      ...
      "stackable-telemetry" = rec {
        ...
        version = "0.6.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../operator-rs/main/crates/stackable-telemetry; };
      ...
      "stackable-versioned" = rec {
        ...
        version = "0.7.1";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../operator-rs/main/crates/stackable-versioned; };
      ...
      "stackable-versioned-macros" = rec {
        ...
        version = "0.7.1";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../operator-rs/main/crates/stackable-versioned-macros; };
        procMacro = true;
      ...
      "stackable-webhook" = rec {
        ...
        version = "0.3.1";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../operator-rs/main/crates/stackable-webhook; };
