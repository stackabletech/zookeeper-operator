...
chmod +x "docs/modules/zookeeper-operator/examples/getting_started/getting_started.sh" \
  || chmod +x "docs/modules/zookeeper-operator/examples/getting_started/code/getting_started.sh" \
  || true
